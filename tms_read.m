...
% Added E.N 
%{
The "description" structure contains the channel names and the units.
Why is there a "Lo" and "Hi" field for each channel? 
In the "data" structure each channel has 1 datarow in uV.

% example of the call with saving of the data
filename_now = 'default - 20170330T120218';
extensions_now = '.EEG.Poly5';
path_now = ['C:\Matlab testen RU\EEG\AM tones\Measurements\170330 subject 2\' filename_now];
data = tms_read([filename_now extensions_now],path_now);
saving_dir_now  = 'C:\Users\Elisabeth Noordanus\Documents\MATLAB\';  % Directory where Matlab has access
% save([saving_dir_now filename_now '_raw_refa'], 'data');
% And when the file is > 2GB:
save([saving_dir_now filename_now '_raw_refa'], 'data','-v7.3');
%save('C:\Matlab testen RU\EEG\AM tones\Measurements\170330 subject 2\default - 20170330T120218\dataraw_tmsi','dataraw_tmsi','-v7.3');
%}
